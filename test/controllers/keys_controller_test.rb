...
class KeysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create key" do
    assert_difference('Key.count') do
      post keys_url, params: { key: { asset_id: @key.asset_id, iv: @key.iv, kFile: @key.kFile, owner_id: @key.owner_id } }
    end
  ...
  test "should update key" do
    patch key_url(@key), params: { key: { asset_id: @key.asset_id, iv: @key.iv, kFile: @key.kFile, owner_id: @key.owner_id } }
